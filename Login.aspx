      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
         ...
         <br />
          <br />
          <div>
          <h1 style="font-size:larger; color:black"><center><strong>Enter Correct Email and Password...</strong></center></h1>
          <br />
        ...
        <table style="width:30%; flex-align:center">
            ...
            <tr>
              ...
              <tr>
               <td><b>Password</b></td>
               <td>
                   <asp:TextBox ID="txtPass" runat="server" required="required"></asp:TextBox>
                  </td>
            </tr>
            ...
            <tr>
                <td>
                    <td>
                        ...
                        <asp:Button ID="btnlogin" runat="server" Text="Login" value="Login" OnClick="btnlogin_Click" />
